...
![Ежемесячная динамика коэффициентов](images/department_monthly_dynamics.png)

### Годовое сравнение менеджеров по коэффициенту 1

![Коэффициент 1 по менеджерам](images/managers_coef1_year.png)

### Годовое сравнение менеджеров по коэффициенту 2

![Коэффициент 2 по менеджерам](images/managers_coef2_year.png)
